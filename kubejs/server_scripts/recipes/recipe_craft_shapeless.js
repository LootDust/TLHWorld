ServerEvents.recipes(event => {
    ...
    event.shapeless(Item.of('create:wrench'), [Item.of('tacz:modern_kinetic_gun[minecraft:custom_data={"GunFireMode":"SEMI","HasBulletInBarrel":1,"GunId":"create_armorer:special_melee_wrench","GunCurrentAmmoCount":1}]')])

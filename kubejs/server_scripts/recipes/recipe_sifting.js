ServerEvents.recipes(event => {
    ...
    ], Item.of('minecraft:rooted_dirt'), Item.of('createsifter:string_mesh')).processingTime(800).waterlogged(true).advancedSifter(false);
    ...
    ], Item.of('minecraft:dirt'), Item.of('createsifter:string_mesh')).processingTime(600).waterlogged(false).advancedSifter(false);
    event.recipes.createsifter.sifting([
    ...
    event.recipes.createsifter.sifting([
        Output.of('createsifter:raw_tin_piece', 0.01),
        Output.of('createsifter:diorite_pebble', 0.05),
        Output.of('createsifter:stone_pebble', 0.5),
        Output.of('createsifter:calcite_pebble', 0.25),
        Output.of('minecraft:flint', 0.33)
    ], Item.of('minecraft:gravel'), Item.of('createsifter:string_mesh')).processingTime(600).waterlogged(true).advancedSifter(false);
    ...
    event.recipes.createsifter.sifting([
        Output.of('minecraft:clay_ball', 0.15),
        Output.of('minecraft:redstone', 0.001),
        Output.of('createsifter:dust', 0.01)
    ], Item.of('minecraft:sand'), Item.of('createsifter:string_mesh')).processingTime(700).waterlogged(true).advancedSifter(false);
    ...
    ], Item.of('createsifter:dust'), Item.of('createsifter:string_mesh')).processingTime(10).waterlogged(false).advancedSifter(false);
    ...
    event.recipes.createsifter.sifting([
        Output.of('minecraft:clay_ball', 0.15),
        Output.of('minecraft:glowstone_dust', 0.01),
        Output.of('createsifter:dust', 0.5),
        Output.of('ae2:sky_dust', 0.05)
    ], Item.of('minecraft:sand'), Item.of('createsifter:tin_mesh')).processingTime(500).waterlogged(true).advancedSifter(false);

    event.recipes.createsifter.sifting([
        Output.of('minecraft:white_concrete', 0.125),
        Output.of('minecraft:light_gray_concrete', 0.125),
        Output.of('minecraft:gray_concrete', 0.125),
        Output.of('minecraft:black_concrete', 0.125),
        Output.of('minecraft:brown_concrete', 0.125),
        Output.of('minecraft:red_concrete', 0.125),
        Output.of('minecraft:orange_concrete', 0.125),
        Output.of('minecraft:yellow_concrete', 0.125),
        Output.of('minecraft:lime_concrete', 0.125),
        Output.of('minecraft:green_concrete', 0.125),
        Output.of('minecraft:cyan_concrete', 0.125),
        Output.of('minecraft:light_blue_concrete', 0.125),
        Output.of('minecraft:blue_concrete', 0.125),
        Output.of('minecraft:purple_concrete', 0.125),
        Output.of('minecraft:magenta_concrete', 0.125),
        Output.of('minecraft:pink_concrete', 0.125)
    ], Item.of('createsifter:dust'), Item.of('createsifter:tin_mesh')).processingTime(80).waterlogged(true).advancedSifter(false);
